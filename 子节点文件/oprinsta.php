...
<!-- main container -->
    <div class="content">
        ...
        $sql = "SELECT * FROM inCage UNION SELECT * FROM ibCage ORDER BY opedate DESC ";
        ...
        <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                <div style="margin-bottom: 30px;" class="row-fluid header">
                    <h3 style="margin-bottom: 20px;">采购员采购统计</h3>
    ...
    <script type="text/javascript">
        ...
        function search() {
            ...
            filter(function(tr) {
                if(stime && CompareDate(stime,tr.cells[1].innerText)) {
                    return false;
                }
                if(etime && CompareDate(tr.cells[1].innerText,etime)) {
                    return false;
                }
