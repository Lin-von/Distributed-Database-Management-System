        ...
        <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                <div style="margin-bottom: 30px;" class="row-fluid header">
                    <h3 style="margin-bottom: 20px;">配件采购统计</h3>
                ...
                $sql = "select inCage.*,inCage_detail.* from inCage,inCage_detail where inCage.`id`=inCage_detail.`recordid`
union
select ibCage.*,ibCage_detail.* from ibCage,ibCage_detail where ibCage.`id`=ibCage_detail.`recordid`
order by opedate desc";
    ...
    <script type="text/javascript">
        ...
        for(var i = 0; i < size; i++) {
            ...
            tr.cells[6].innerText = accprice[id];
            tr.cells[8].innerText = parseInt(accpriceo[id])*parseInt(tr.cells[7].innerText);
