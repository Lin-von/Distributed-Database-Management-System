            ...
            <div id="pad-wrapper" class="users-list">
                <div style="margin-bottom: 30px;" class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        <input id="searchname" style="margin-bottom: 0; max-width: 80%;" type="text" class="span5 " placeholder="输入客户名称" />
                        ...
                        <a style="margin-top: 40px;" href="newcli.php" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            添加客户
                        </a>
                    </div>
