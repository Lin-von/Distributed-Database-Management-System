            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="Controller/Controller.php?controller=Set&method=updateSup" method="post"/>
                            <input name="id" style="display: none" value="<?php echo $info['id'];?>">
                                <div class="span12 field-box">
                                    <label>名称:</label>
                                    <input class="span3" type="text" name="supname" value="<?php echo $info['supname'];?>"/>
                                </div>

                            <div class="span12 field-box">
                                <label>联系人</label>
                                <input class="span2" type="text" name="connector" value="<?php echo $info['connector'];?>"/>
                            </div>
                            <div class="span12 field-box">
                                <label>电话</label>
                                <input class="span2" type="text" name="tel" value="<?php echo $info['tel'];?>"/>
                            </div>
                            <div class="span12 field-box">
                                <label>地址</label>
                                <input class="span2" type="text" name="address" value="<?php echo $info['address'];?>"/>
                            </div>
