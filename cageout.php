...
<!-- main container -->
        ...
        <div class="container-fluid">
            <div id="pad-wrapper" class="users-list">
                <div style="margin-bottom: 30px;" class="row-fluid header">
                    <h3 style="margin-bottom: 20px;">配件销售</h3>
                    <div class="span10 pull-right">
                        <div class="ui-dropdown">
                            <select style="min-height: 30px;margin-top: 40px; width: 150px;" id="client" >
    ...
    <script type="text/javascript">
        ...
        function addRow(tbody,obj,cnt,lef)
        {
            ...
            newTd4.innerHTML= "<td><input type=\"text\" value=\""+cnt+"\" onchange='recalc(this)' style=\"width: 20px;height: 10px;\"></td>\n";
        ...
        function recalc(tem) {
            ...
            if(parseInt(lef)<parseInt(cnt)) {
                ...
                deleteCurrentRow($(tem).parents("tr").children("td").eq(6)[0].getElementsByTagName('div')[0]);
            }
        ...
        function subcheck() {
            ...
            $.ajax({
                type: 'POST',
                url: 'Controller.php?controller=Cage&method=outCage',
                data: "idstr="+idstr+"&cntstr="+cntstr+"&client="+cli+"&operator="+ope+"&cost="+sum,
                success: window.location.href='cageout.php'
            });
