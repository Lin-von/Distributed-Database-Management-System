            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span9 with-sidebar">
                        <div class="container">
                            <form class="new_user_form inline-input" action="Controller/Controller.php?controller=Set&method=updateCli" method="post"/>
                            <input name="id" style="display: none" value="<?php echo $info['id'];?>">
                                <div class="span12 field-box">
                                    <label>名称:</label>
                                    <input class="span3" type="text" name="cliname" value="<?php echo $info['cliname'];?>"/>
                                </div>
